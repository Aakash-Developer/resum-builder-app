        ...
        <form onSubmit={handleSubmit}>
          <div className="flex gap-0 flex-col md:flex-row md:gap-3">
            <div className="w-full md:w-1/2">
              <InputField type="text" name="degree" placeholder="Degree" value={formData.degree} changeHandler={handleInputChange} />
            </div>
            <div className="w-full md:w-1/2">
              <InputField type="text" name="school" placeholder="School / University" value={formData.school} changeHandler={handleInputChange} />
            </div>
          </div>

          <div className="flex items-center py-3">
            <input type="checkbox" id="showEndDate" name="showEndDate" checked={showEndDate} onChange={handleShowEndDateChange} className="mr-2" />
